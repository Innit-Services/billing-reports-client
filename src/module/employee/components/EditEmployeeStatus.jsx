    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="bg-white border border-gray-200 rounded-lg shadow flex flex-col h-[95vh] w-[35vw]">
          ...
          <div className="flex-grow overflow-y-auto p-3">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className=" flex  ">
                <label
                  htmlFor="updated_by"
                  className="w-1/2 block text-base font-medium text-gray-700 mb-1"
                >
                  Updated By
                </label>
                <input
                  type="text"
                  {...register("updated_by")}
                  className="w-1/2 rounded-md  bg-white  text-base  text-gray-700 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                  disabled
                />
              </div>
            </form>
          ...
          <footer className="flex justify-end items-center p-2 border-t-2 bg-gray-50">
            <button
              type="button"
